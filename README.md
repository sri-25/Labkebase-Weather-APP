...
- `notebooks/hnsw_benchmark.py` — HNSW vs. sequential-scan query latency benchmark, run against live data (167 rows: index wasn't faster at this scale, expected — see README_WEATHER.md)
